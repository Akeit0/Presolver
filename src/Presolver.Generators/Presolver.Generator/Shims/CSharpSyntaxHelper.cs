...
internal sealed class CSharpSyntaxHelper : AbstractSyntaxHelper
{
    ...
    {
        return ((AttributeListSyntax)node).Attributes;
    }
    ...
    {
        return ((NameSyntax)node).GetUnqualifiedName().Identifier;
    }
    ...
    static void AddAliases(SyntaxList<UsingDirectiveSyntax> usings, ref ValueListBuilder<(string aliasName, string symbolName)> aliases, bool global)
    {
