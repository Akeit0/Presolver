...
// Copied from https://github.com/dotnet/runtime/blob/1473deaa50785b956edd7d078e68c0581c1b4d95/src/libraries/Common/src/Roslyn/GetBestTypeByMetadataName.cs
...
internal static class RoslynExtensions
{
    ...
    ///         <item>
    ///             <description>
    ///                 If only one type with the given name is found within the compilation and its referenced assemblies,
    ///                 that
    ...
    public static ITypeSymbol? GetBestTypeByMetadataName(this Compilation compilation, string fullyQualifiedMetadataName)
    {
    ...
    /// <returns></returns>
    public static ITypeSymbol? GetBestTypeByMetadataName(this Compilation compilation, Type type)
    {
        return type.IsArray || type.FullName is null
    ...
    static SymbolVisibility GetResultantVisibility(this ISymbol symbol)
    {
